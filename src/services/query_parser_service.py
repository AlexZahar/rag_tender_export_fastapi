...
query_gen_str = """
    Bevor Sie die Anfrage analysieren, führen Sie bitte folgende Bereinigungsschritte am Ausschreibungstext durch:
            ...
            17. Entfernen Sie unnötige Daten, die nicht Teil der Systemeigenschaften sind, wie:
                - "Qualitätsstufe Q2 als Standardverspachtelung, gemäß IGG-Merkblatt 2."
                - "Gipsplatten, Spachtel mit Prüfsiegel "geprüft und empfohlen vom IBR""
                - Ähnliche nicht-technische Beschreibungen oder Zertifizierungen.
